...
const CreateContent = () => {
  ...
  // Function to add a content block to the state
    ...
    if (blockType === "Text") {
      newBlock.field = (
        <FormEditorField
          ...
          sx={{ width: "100%" }}
          control={control}
          name={`description_${contentBlocks.length}`}
        />
      );
    }
    ...
    if (blockType === "Image") {
      ...
      newBlock.field = (
        <FormTextField
          ...
          label="URL"
          variant="outlined"
          name={`url_${contentBlocks.length}`}
        />
      );
      ...
      newBlock.field = (
        <FormTextField
          ...
          label="Youtube Link"
          variant="outlined"
          name={`youtubeurl_${contentBlocks.length}`}
        />
      );
    }
        ...
        return (
          <Grid sx={{ display: "flex" }} item xs={12} key={index}>
            <Box className="add-file">
              <input
                name={`image-file-input-${index}`}
                id={`image-file-input-${index}`} // Use unique ID
                type="file"
                accept="image/*"
              ...
              <label htmlFor={`image-file-input-${index}`}>
              ...
              {block.selectedImage && (
                <Box>
                  ...
                  <img
                    src={URL.createObjectURL(block.selectedImage)}
                    alt="Selected"
      ...
      case "Video":
        return (
          <Grid sx={{ display: "flex" }} item xs={12} key={index}>
            <Box className="add-file">
              <input
                name={`video-file-input-${index}`}
                id={`video-file-input-${index}`} // Use unique ID
                type="file"
                accept="video/*"
